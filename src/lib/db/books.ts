...
const SACRED_TEXT_FALLBACKS: Record<string, any> = {
  "holy-quran-arabic": {
    ...
    status: "published",
    language: "ar",
    description: "The authoritative Arabic text of the Holy Quran, presented under verified rights governance with 0 AI intervention.",
    source_url: "https://quran.ksu.edu.sa/",
    authors: { name: "Sacred Canon of Islam", slug: "sacred-canon-islam" },
  },
  "sahih-bukhari": {
    ...
    status: "published",
    language: "ar",
    description: "Classical Hadith collection compiled by Imam Muhammad al-Bukhari.",
    source_url: "https://sunnah.com/bukhari",
    authors: { name: "Imam Al-Bukhari", slug: "imam-al-bukhari" },
  },
  "tafsir-ibn-kathir": {
    ...
    status: "published",
    language: "ar",
    description: "Classical Quranic exegesis by Hafiz Ibn Kathir.",
    source_url: "https://quran.com",
    authors: { name: "Ibn Kathir", slug: "ibn-kathir" },
  },
  "holy-bible-kjv": {
